...
<%-- 		<template:addResources type="css" resources="jahia.fancybox-form.css"/> --%>
		...
		<c:if test="${not renderContext.loggedIn}">
			...
			&nbsp;<a href="#unsubscribeFormPanel-${currentNode.identifier}" rel="${currentNode.identifier}" class="showSubscriptionForm" title="<fmt:message key='label.unsubscribe'/>"><img src="<c:url value='${url.currentModule}/icons/unsubscribe.png'/>" alt="<fmt:message key='label.unsubscribe'/>" title="<fmt:message key='label.unsubscribe'/>" height="16" width="16"/><fmt:message key='label.unsubscribe'/></a>
			</p>
			<div class="jahiaFancyboxForm">
			<div id="subscribeFormPanel-${currentNode.identifier}" style="width: 400px; height: ${230 + fn:length(currentNode.properties['j:fields'])*50}px;">
			...
			<div class="jahiaFancyboxForm">			
			<div id="unsubscribeFormPanel-${currentNode.identifier}" style="width: 400px;height: 230px;">
			    <div class="popup-bodywrapper">
